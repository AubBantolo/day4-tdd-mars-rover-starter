...
class MarsRoverTest {
    ...
    @Test
    void should_change_to_location_0_0_E_when_executeCommand_given_0_0_West_and_command_Turn_Right() {
        // Given
    ...
    @Test
    void should_change_to_location_0_0_W_when_executeCommand_given_0_0_East_and_command_Turn_Right() {
        // Given
    ...
    @Test
    void should_change_to_location_0_0_N_when_executeCommand_given_1_0_East_and_command_Turn_Left() {
        // Given
        Location initialLocation = new Location(1, 0, Direction.EAST);
        Command givenCommand = Command.TURN_LEFT;
        MarsRover marsRover = new MarsRover(initialLocation);
        // When
        marsRover.executeCommand(givenCommand);
    ...
    @Test
    void should_change_to_location_0_0_S_when_executeCommand_given_0_0_North_and_command_Turn_Right() {
        // Given
        Location initialLocation = new Location(0, 0, Direction.NORTH);
        Command givenCommand = Command.TURN_RIGHT;
        MarsRover marsRover = new MarsRover(initialLocation);
    ...
    @Test
    void should_change_to_location_0_0_S_when_executeCommand_given_Negative_1_0_West_and_command_Turn_Left() {
        // Given
